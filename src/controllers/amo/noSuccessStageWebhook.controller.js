...
const { noSuccessStageData } = require("../../const/GSSendData.js");
...
module.exports = async (req, res, next) => {
  try {
    ...
    console.log(`Сделка ${leadId} на этапе "Закрыто и не реализовано"`);
    ...
    const { data } = await axios.post(
      process.env.GOOGLE_MACROS_NO_SUCCESS_STAGE_LINK,
      googleSheetsData
    );
