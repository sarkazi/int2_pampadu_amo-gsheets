...
const { collectInfoData } = require("../../const/GSSendData.js");
...
module.exports = async (req, res, next) => {
  try {
    ...
    console.log(`Сделка ${leadId} на этапе "Сбор информации о клиенте"`);
    ...
    const { data } = await axios.post(
      process.env.GOOGLE_MACROS_COLLECT_INFO_STAGE_LINK,
      googleSheetsData
    );
